...
$(document).ready(function () {
    ...
    document.querySelectorAll(".customDropDown").forEach(function (dropDown) {
        dropDown.addEventListener("click", (e) => {
            ...
            if (e.target.classList.contains("searchCoinDrp")) {
                document.getElementById("tokenseach1").focus();
            }
    ...
    document.querySelectorAll(".basic_banner_read_btn").forEach(function (readBtn) {
        readBtn.addEventListener("click", () => {
            ...
            if (basic_banner_read_btn === false) {
                ...
                basicBannerText.style.display = 'none';
    ...
    // filterToggelBtn
    document.querySelectorAll(".filterToggleBtn").forEach(function (filterBtn) {
        filterBtn.addEventListener("click", () => {
            document.querySelector(".filterToggle").style.display = 'block';
        })
    })
    ...
    document.querySelectorAll(".hideCustomDrp").forEach(function (hideDrp) {
        hideDrp.addEventListener("click", () => {
    ...
    document.querySelector(".mainTable").addEventListener("scroll", function (e) {
        ...
        if (isScroll) {
            document.querySelectorAll(".ListingTable th:nth-child(3), td:nth-child(3)").forEach(function(elem){
    ...
    document.querySelectorAll(".currenciesTable, .exchangeTable").forEach(function(table){
        table.addEventListener("scroll", function (e) {
            let isScroll = e.currentTarget.scrollLeft;
            if (isScroll) {
                document.querySelectorAll(".ListingTable th:nth-child(2), td:nth-child(2)").forEach(function(elem){
                    elem.classList.add("before");
                });
            } else {
                document.querySelectorAll(".ListingTable th:nth-child(2), td:nth-child(2)").forEach(function(elem){
    ...
    // .historical-data
    document.querySelector(".historical-data").addEventListener("scroll", function (e) {
        let isScroll = e.currentTarget.scrollLeft;
        if (isScroll) {
            document.querySelectorAll(".ListingTable th:nth-child(1), td:nth-child(1)").forEach(function(elem){
                elem.classList.add("before");
            });
        } else {
            document.querySelectorAll(".ListingTable th:nth-child(1), td:nth-child(1)").forEach(function(elem){
    ...
    // .financialTable
    document.querySelector(".financialTable").addEventListener("scroll", function (e) {
        let isScroll = e.currentTarget.scrollLeft;
        if (isScroll) {
            document.querySelectorAll(".ListingTable th:nth-child(1), td:nth-child(1)").forEach(function(elem){
                elem.classList.add("before");
    ...
    // searchPopup
    document.querySelector(".header-for-mobile .searchPopup").addEventListener("click", ()=>{
        document.body.style.overflow = "hidden"
        document.querySelector(".searchDiv-for-mb").classList.add("active");
    });
    

    document.querySelector(".searchpopupHider").addEventListener("click", ()=>{
        document.body.style.overflow = "auto"
    ...
    window.addEventListener("scroll", function(){
        ...
        if(scrolled > 200){
            this.document.querySelector(".gototpIconDiv").style.display= "block";
        }else{
            this.document.querySelector.apply(".gototpIconDiv").style.display = "none";
        }
    })
    
    document.querySelector(".gototopIconDiv").addEventListener("click", ()=>{
    ...
    document.querySelector(".popupRemover").addEventListener("click", ()=>{
    ...
    isHighLight.addEventListener("click", ()=>{
        document.querySelector(".Banner_cards").style.display = "block";
    })
...
document.querySelectorAll(".faqAcc .flexAccHead").forEach(function(accHead){
    accHead.addEventListener("click", ()=>{
        let AccHeadObj = accHead;
        AccHeadObj.parent().siblings().children().removeClass('active');
    AccHeadObj.parents(".faqAcc li").find(".faqDesc").addClass("active", 2000);
    })
})
...
function toggleCurrencyMoreData(elem) {
    ...
    if (currentstate == alternate) {
        document.querySelector(".currencyDetail .bottomListing").style.display = 'none';
